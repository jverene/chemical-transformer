...
150M models, scoped to compute-limited regimes, with dense deployment requiring no architecture
...
the FFN training FLOPs on 11M and 150M models---a claim we scope to
...
pre-registered 10k-step decision rule ($-5.3\%$ loss at $50\%$ of billed
FFN FLOPs), with natural-language transfer as the stated boundary of the
current evidence (\S\ref{sec:scale}, \S\ref{sec:nl}).
